...
of machine learning over the past few decades \citep[for
example][]{LeCun:2015}.
...
found at \url{https://github.com/dfm/celerite-grad}.

\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.9\textwidth]{figure.pdf}
\caption{%
    The computational scaling of the algorithms prsented in this note.
    \emph{(top row)}: The computational cost of computing \eq{loglike} as a
    function of the number of datapoints ($N$; left) and the model complexity
    ($J$; right).
